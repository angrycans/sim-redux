...
var Connect = /** @class */ (function (_super) {
    ...
    Connect.prototype.getActions = function () {
        ...
        return (0, bindActions_1.default)(actions, this.context.store); // buildInActions
    };
    /**
     * 计算 computed
     */
...
function connect(param, _actor, _computed) {
    ...
    return function (Child) {
        return /** @class */ (function (_super) {
            tslib_1.__extends(ConnectWrapper, _super);
            function ConnectWrapper() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            ConnectWrapper.prototype.render = function () {
                var props = this.props;
                return (React.createElement(Connect, tslib_1.__assign({}, props, { mapToProps: state, actions: actions, computed: computed }), function (mappedProps) { return React.createElement(Child, tslib_1.__assign({}, mappedProps, props)); }));
            };
