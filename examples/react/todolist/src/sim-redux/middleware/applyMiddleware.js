...
var finalMiddleware = function (store, args, name) { return function (action) { return (0, set_1.default)(store, action.apply(void 0, args), name); }; };
function applyMiddleware() {
    ...
    return function (store, action, args, name) {
        if (middlewares.length < 1) {
            return (0, set_1.default)(store, action.apply(void 0, args), name);
        }
